 ...
 */
public class AirHockeyRendererC4 implements GLSurfaceView.Renderer {
    ...
    public AirHockeyRendererC4() {
        /**
         *  (版本修改)
         * **/
        float[] tableVerticesTriangles = {

                //数据结构：x（x坐标）,y（y坐标）,z（z坐标），w（剪裁空间值），R（红色通道）,G（绿色通道）,B（蓝色通道）
                ...
                //边框1
                -0.6f, -0.9f, 0f, (15 / 16f), 1f, 1f, 0f,
                0.6f, -0.9f, 0f, (15 / 16f), 1f, 0f, 0f,
                //边框2
                0.6f, 0.9f, 0f, (33 / 16f), 1f, 1f, 0f,
                -0.6f, 0.9f, 0f, (33 / 16f), 1f, 0f, 0f,
                //边框3
                -0.6f, -0.9f, 0f, (15 / 16f), 1f, 1f, 0f,
                -0.6f, 0.9f, 0f, (33 / 16f), 1f, 0f, 0f,
                //边框4
