...
public class CustomClockView extends View{
    ...
    private static final String BIAOPAN_LOGO = "Sentox";//表盘logo

    private int color = Color.BLACK;//表盘圆圈的颜色
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        radius = getMeasuredWidth()>getMeasuredHeight()?getMeasuredHeight()/2:getMeasuredWidth()/2;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mHandler.sendEmptyMessageDelayed(HANDLER_MSG,300);
        /**
    ...
    private void minutes(Canvas canvas) {
        ...
        canvas.drawLine(0, 20, 0, -(radius - 50), mMinutesPaint);
    ...
    private void second(Canvas canvas) {
        ...
        canvas.drawLine(0, 30, 0, -(radius - 20), mSecondPaint);
