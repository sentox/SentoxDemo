...
import com.sentox.demo.function.base.application.ThreadHelper;
...
public final class PreferencesManager {
    ...
    public static PreferencesManager getSharedPreference(String name) {
        return getSharedPreference(GOApplication.getAppContext(), name, Context.MODE_MULTI_PROCESS);
    }
    ...
    private static void apply(final Editor editor) {
        ThreadHelper.postRunOnShortTaskThread(new Runnable() {
